...
export { ServerInsertedHTMLContext, useServerInsertedHTML, } from 'next/dist/shared/lib/server-inserted-html.shared-runtime';
/**
 * Get the router methods. For example router.push('/dashboard')
 */
export declare function useRouter(): import('next/dist/shared/lib/app-router-context.shared-runtime').AppRouterInstance;
interface Params {
