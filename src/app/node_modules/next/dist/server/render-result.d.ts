...
export type RenderResultResponse = ReadableStream<Uint8Array>[] | ReadableStream<Uint8Array> | string | null;
...
export default class RenderResult<Metadata extends RenderResultMetadata = RenderResultMetadata> {
     ...
     */
    static fromStatic(value: string): RenderResult<StaticRenderResultMetadata>;
