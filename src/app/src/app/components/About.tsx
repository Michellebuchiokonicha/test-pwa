        ...
        <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">About The Girls like me</h2>
                    <p className="mt-6 text-lg leading-8 text-gray-300">The girls like me Africa is an initiative of Michelle Onyebuchi Okonicha, a sound and experienced technologist
                        who having faced hurdles herself, decided to help girls like her overcome hurdles themselves. This iniitiative is aimed at seeong more women become regardless of their background
                        and environment.
                        We are creating an enabling platform for women to thrive in various careers.
                    </p>
                </div>
